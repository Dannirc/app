        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    var buttons = '<a href="/erp/jobTecnic/update/' + row.id + '/" class="btn btn-warning btn-xs"><i class="fas fa-edit"></i></a> ';
                    buttons += '<a href="/erp/jobTecnic/delete/' + row.id + '/" type="button" class="btn btn-danger btn-xs"><i class="fas fa-trash-alt"></i></a>'
                    return buttons;
                }
            },
            {
