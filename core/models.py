...
class BaseModel(models.Model):
    ...
    # " related_name = 'user_creation' " es utilizado para que no se produzca un error cuando se establezca la relacion
    data_creation = models.DateTimeField(auto_now_add=True, null=True, blank=True)
